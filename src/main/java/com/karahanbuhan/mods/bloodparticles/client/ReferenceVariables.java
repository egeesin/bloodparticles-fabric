...
public enum ReferenceVariables {
    ...
    BLOOD_WHEN_MELTING("blood_when_melting", "Whether there should be blood particles when a snowman melts."),
    ...
    BLOOD_WHEN_SUICIDE("blood_when_suicide", "Whether there should be blood particles when an entity uses /kill command."),
